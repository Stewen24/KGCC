...
def base_options(func):
    ...
    @click.option("--batch-size", default=96, type=int, help="Mini-batch size")
    ...
    @click.option(
        ...
        default=QuantArchitectures.pr_pl_quantized.name,
...
class multi_optimizer_options:
    ...
    def __call__(self, func):
        ...
        @click.option(
            ...
            default="RMSprop",
            type=click.Choice(["SGD", "Adam", "RMSprop"], case_sensitive=False),
            help="Class name of torch Optimizer to be used.",
        )
        @click.option(
        ...
        @click.option(
            f"--{prefix_option}momentum", default=0.9, type=float, help="Optimizer momentum."
        )
        @click.option(
